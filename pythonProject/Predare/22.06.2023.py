...
a = 5
b = 7
# print(a**2 + b**2) varianta simpla cand nu avem multe variabile
...
angajati = [("Ion", 29, 12300), ("Ana", 27, 14000), ("Elena", 25, 11000)] # aici am facut mai multe tuple
for prenume, varsta, salariu in angajati:
    print(f"{prenume} are {varsta} ani si salariul = {salariu}")
# echivalent cu
for el in angajati:
...
def produsul_patr_nedeterminat(*args):
    for a in args:
        print(a)
produsul_patr_nedeterminat(1, 2, 34, 345, 246)
