...
class Cetatean(Om):
    #(Om) - astfel am mostenit/inheritance caracteristicile de la calasa Om, adica parametrii si metodele
    def __init__(self, prenume, an_nastere, nationalitate):
        ...
        # initializezaza din clasa superioara
