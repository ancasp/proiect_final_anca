...
# inclusiv liste in liste

listx = ['hello', 9.3, [True, False, 8], 15]
print(listx, type(listx))
# len - functie care ne zice lungimea
print(len(listx))
...
ultimul = listx[3] # indexul 3 = al 4lea element, python incepe indexarea de la 0
# SAU
ultimul = listx[len(listx) - 1] # lungimea listei - 1 !!! Nu este forma recomandata
# SAU
...
primele_3 = nume[:3] # cu : imi printeaza pana la iar fara : imi printeaza fix elementul pe care il mentionez, si dupa
...
nume_1_4 = nume[1:5] # de la indexul 1 inclusiv pana la indexul 5 exclusiv
...
ani.remove(87) # sterge prima valoare intalnita nu pe toate deodata
print(ani)
...
lisx[1] = 99  # asta nu se poate executa
print(lisx)
...
# un dictionar cu datele de contact (partiale) al unei persoane fictive

numele = contact["Nume"] # putem accesa valorile dictionarului dupa cheile sale nu dupa index
# dictionarul nu este ordonat adica nu putem sti are este elementul al x-lea
print(numele)

nr_strazii = contact["adresa"]["nr"]
print(nr_strazii)

del contact["emailuri"] # modalitate de stergere a cheilor cu valori asociate
print(contact)

contact["cheie_noua"] = "valoare noua"
# am creat o cheie noua cu o valoare de tip string
print(contact)

contact[45] = 7.8  # am creat o cheie noua 45 de tip int cu valoarea 7.8 de tip float; inainte de : este cheia
# si dupa este valoarea
print(contact)
...
# incearca instructiune, daca nu merge fa altceva
try:
    print(contact["Prenumeeeee"])
except:
