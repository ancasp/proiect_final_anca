"""
Django settings for asbook project.
...
SECRET_KEY = 'django-insecure-^!av2y79^9r+qz#mwmd*asgbsqt!w7rs8o42*(h!nun()y%mhj'
...
WSGI_APPLICATION = 'asbook.wsgi.application'
